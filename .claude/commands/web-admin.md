...
### 3단계: 작업 실행 (web-admin 에이전트)

web-admin 에이전트에 작업을 위임한다. 에이전트는 아래 규칙을 따른다:
...
- 도메인별 디렉토리 (product/, user/, roulette/, order/)
- 도메인별 API 모듈 (api/product.ts 등)
